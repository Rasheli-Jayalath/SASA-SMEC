...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <main class="main-content mt-1 border-radius-lg" id="main-content">
    ...
    <script>
          ...
          xmlhttp.open("GET","../Scripts/table_ajax/ajax_user_crop.php?yr_name=<?php echo $year; ?>&q="+str,true);
          xmlhttp.send();
    ...
    $start = ($page_no -1)* $result_per_page;
        ...
        <colgroup>
         ...
         $table .= "</table>";
           ...
           // first page
	$first = "<a href=\"table_user_crop.php?p=1&yr_name={$year}\"> <i class=\"fa fa-angle-double-left\"></i>   First  </a>";

	// last page
	$last_page_no = ceil($total_results/$result_per_page);
	$last = "<a href=\"table_user_crop.php?p={$last_page_no}&yr_name={$year}\">Last  <i class=\"fa fa-angle-double-right\"></i></a>";
	...
	if ($page_no >= $last_page_no) {
		...
		$next = "<a href=\"table_user_crop.php?p={$next_page_no}&yr_name={$year}\">Next   <i class=\"fa fa-angle-right\"></i>  </a>";	
	}
	...
	if ($page_no <= 1) {
		...
		$prev = "<a href=\"table_user_crop.php?p={$prev_page_no}&yr_name={$year}\"> <i class=\"fa fa-angle-left\"></i>  Previous</a>";	
	}
