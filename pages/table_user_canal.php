...
<div class= "sidebar 	" id="sidenav-main" style="overflow-y: hidden; bottom: 0: display: none;" >
  ...
  <main class="main-content mt-1 border-radius-lg" id="main-content">
    ...
    $start = ($page_no -1)* $result_per_page;
        ...
        <colgroup>
         ...
         $table .= "</table>";
           ...
           // first page
	$first = "<a href=\"table_user_canal.php?p=1&yr_name={$year}\"> <i class=\"fa fa-angle-double-left\"></i>   First  </a>";

	// last page
	$last_page_no = ceil($total_results/$result_per_page);
	$last = "<a href=\"table_user_canal.php?p={$last_page_no}&yr_name={$year}\">Last  <i class=\"fa fa-angle-double-right\"></i></a>";
	...
	if ($page_no >= $last_page_no) {
		...
		$next = "<a href=\"table_user_canal.php?p={$next_page_no}&yr_name={$year}\">Next   <i class=\"fa fa-angle-right\"></i>  </a>";	
	}
	...
	if ($page_no <= 1) {
		...
		$prev = "<a href=\"table_user_canal.php?p={$prev_page_no}&yr_name={$year}\"> <i class=\"fa fa-angle-left\"></i>  Previous</a>";	
	}
