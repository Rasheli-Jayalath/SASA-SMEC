...
<div class="well">
            ...
            <thead style="background-color:#337ab7; vertical-align:middle; text-align:center;">
             <tr>
            <th colspan="40" align="center"><?php echo $report_title." ".$default_year;?></th>
            </tr>
            <tr>
            <th rowspan="3" style="text-align:center; vertical-align:middle">Crop</th>
            <th>Month</th>
            <?PHP 
   ...
   $objCrops->getCrops();
	...
	?>
        <tr>
          ...
          <td align="center" valign="middle"><?php 	 echo "m3/ha";  ?></td>
           <?php  
 ...
 // $objTimescaleT->setProperty("end",$end_period);
  $timescae_res=$objTimescaleT->getTimescale();
	while($trows=$objTimescaleT->dbFetchArray())
	{
			...
			$crp_perc=$crp_sch["percent"]*$crows["cr_wat_req"]/(100*1);
	?>
