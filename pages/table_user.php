...
<?php include("../includes/left_menu1.php");?> 
  <main class="main-content mt-1 border-radius-lg">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">User Table </li>
          </ol>
          <h5 class="font-weight-bolder mb-0">User Table</h5>
        </nav>
    ...
    $start = ($page_no -1)* $result_per_page;
        ...
        <colgroup>
         ...
         $table .= "</table>";
           ...
           // first page
	$first = "<a href=\"table_user.php?p=1\"> <i class=\"fa fa-angle-double-left\"></i>   First  </a>";

	// last page
	$last_page_no = ceil($total_results/$result_per_page);
	$last = "<a href=\"table_user.php?p={$last_page_no}\">Last  <i class=\"fa fa-angle-double-right\"></i></a>";
	...
	if ($page_no >= $last_page_no) {
		...
		$next = "<a href=\"table_user.php?p={$next_page_no}\">Next   <i class=\"fa fa-angle-right\"></i>  </a>";	
	}
	...
	if ($page_no <= 1) {
		...
		$prev = "<a href=\"table_user.php?p={$prev_page_no}\"> <i class=\"fa fa-angle-left\"></i>  Previous</a>";	
	}
