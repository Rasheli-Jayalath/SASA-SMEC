      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">User Table Form</li>
          </ol>
          <h5 class="font-weight-bolder mb-0">User Table Form</h5>
        </nav>
        ...
        <div class="col-md-6 m-auto py-4  bg-gradient-secondary">
           <div class="col-md-10 m-auto py-4 border border-secondary rounded ">
              <div class="col-md-10 m-auto py-4  ">
                ...
                <form action="../Classes/save/user_table_save.php"  method="post" class="text-white" enctype="multipart/form-data" autocomplete="off">

                  <div class = "form-group">
                      <input type="text" name="u_name"         minlength="2" maxlength="10"     placeholder="User Name "                   required  class="form-control move-on-hover" >
                  </div>

                  <div class = "form-group input-group  move-on-hover">
                      <input type="text" name="u_business_name"    minlength="2" maxlength="30"     placeholder="Business Name"                required  class="form-control" >
                    </div>

                  <div class = "form-group input-group  move-on-hover">
                      <input type="text" name="u_phone"    minlength="2" maxlength="30"     placeholder="Phone number"                 required  class="form-control \" >
                  </div>

                  <div class = "form-group input-group  move-on-hover">
                      <input type="text" name="u_email"    minlength="2" maxlength="30"     placeholder="Email ID`"                    required  class="form-control \" >
                  </div>

                  <div class = "form-group input-group  move-on-hover">
                      <input type="text" name="u_area"    minlength="2" maxlength="30"     placeholder="Total Area to be irrigated"   required  class="form-control \" >
