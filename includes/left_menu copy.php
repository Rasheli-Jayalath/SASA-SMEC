...
<aside class="sidebar sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl  " style="overflow-y: hidden; overflow-x: hidden; "   id="sidenav-main ">
    <div class="sidenav-header" style ="">
      ...
      <a class="navbar-brand m-0" href="index.php">
        ...
        <span class="ms-1 font-weight-bold"> SAS Management System </span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse me-n5 ms-n3" id="sidenav-collapse-main" style= "height:80%">
      <ul class="navbar-nav" style=" overflow-y: hidden; overflow-x: hidden; " >
        ...
        <li class="nav-item mt-3">
         ...
         <li class="nav-item">
          <a class="nav-link  " href="irrigation_norms.php?nc_code=<?php echo $nc_code;?>">
            <span class="nav-link-text ms-1">Decadal Crop Water Use Values</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="irrigation_norms_details.php?nc_code=<?php echo $nc_code;?>">
            
            <span class="nav-link-text ms-1">Irrigation Norms and Decadal Crop Water Use Values as Percent</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="irrigation_schedule.php?nc_code=<?php echo $nc_code;?>">
            <span class="nav-link-text ms-1"> Proposed Irrigation Schedule for the SPA </span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="cropping_pattern_summary.php?nc_code=<?php echo $nc_code;?>">
            
            <span class="nav-link-text ms-1">Cropping Pattern Summary </span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="cropping_pattern.php?nc_code=<?php echo $nc_code;?>">
            
            <span class="nav-link-text ms-1">Cropping Pattern </span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="water_distribution_report.php?nc_code=<?php echo $nc_code;?>">
            
            <span class="nav-link-text ms-1">Canal-Wise Water Distribution Plan </span>
          </a>
        </li>
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Setting/Forms</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="pages/form_year.php">
            ...
            <span class="nav-link-text ms-1">Year Form</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="pages/table_net_canal.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="pages/table_crop.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="pages/table_user.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="pages/table_user_canal.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="pages/table_user_crop.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
