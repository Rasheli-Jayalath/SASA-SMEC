...
<aside class="sidenav navbar navbar-vertical  border-0 border-radius-xl scrolll-sidebar mt-n1" style="overflow-y: hidden; overflow-x: hidden; background-color: #dee2e6; height: 99vh;"   id="sidenav-main ">
...
<li class="nav-item">
  <a class="nav-link  " href="pages/form_year.php" style = " text-indent: -0.3em;"   title=" Year Form ">
     <i class="fas fa-circle nav-icon "></i>
    <span class="nav-link-text ms-1">Entering Year Records </span>
  </a>
</li>
<li class="nav-item">
  <a class="nav-link " href="pages/table_net_canal.php" style = " text-indent: -0.3em;"   title=" Manage Network Canal  ">
     <i class="fas fa-circle nav-icon "></i>
    <span class="nav-link-text ms-1">Manage Network Canal </span>
  </a>
</li>
<li class="nav-item">
  <a class="nav-link  " href="pages/table_crop.php" style = " text-indent: -0.3em;"  title=" Manage Crops ">
     <i class="fas fa-circle nav-icon "></i>
    <span class="nav-link-text ms-1"> Manage Crops </span>
  </a>
</li>
<li class="nav-item">
  <a class="nav-link  " href="pages/table_user.php" style = " text-indent: -0.3em;"  title=" Manage Users ">
     <i class="fas fa-circle nav-icon "></i>
...
<!-- <li class="nav-item">
  <a class="nav-link  " href="pages/table_user_canal.php" style = " text-indent: -0.3em;" title=" Manage User Canal ">
     <i class="fas fa-circle nav-icon "></i>
...
<li class="nav-item">
  <a class="nav-link  " href="pages/table_user_crop.php" style = " text-indent: -0.3em;"  title=" Manage User Crops ">
     <i class="fas fa-circle nav-icon "></i>
...
<li class="nav-item">
  <a class="nav-link  " href="pages/form_user_and_crops.php" style = " text-indent: -0.3em;"  title=" Manage User Crops and Crops">
     <i class="fas fa-circle nav-icon "></i>
...
<li class="nav-item">
  <a class="nav-link  " href="pages/form_tscale_irri_sch.php" style = " text-indent: -0.3em;"  title="Manage Proposed irrigation schedule period">
     <i class="fas fa-circle nav-icon "></i>
...
<li class="nav-item">
  <a class="nav-link  " href="pages/form_ts_irri_norms.php" style = " text-indent: -0.3em;"  title="Manage Irrigation Norms">
     <i class="fas fa-circle nav-icon "></i>
