...
class Database extends Property{
	...
	*/
	public function __construct(){
		$this->dbCon = $_SESSION["dbConnection"] ;
		
		// try {
			
			// $host=HOST;
			// $dbnmame=DBNAME;
			//   $this->dbCon = new PDO("mysql:host=$host;dbname=$dbnmame;charset=UTF8", DBUSER, DBPASSWD,array(PDO::ATTR_PERSISTENT => true));
			//   $this->dbCon = new PDO("mysql:host=$host;dbname=$dbnmame;charset=UTF8", DBUSER, DBPASSWD);
